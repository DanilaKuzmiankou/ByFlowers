    ...
    <Box sx={mainContainer}>
      ...
      <Box sx={deliveryDescription}>
        <Typography sx={description}>
          ...
          Доставка по отдаленным районам – от 600 {RUBLE_SIGN}. Возможна срочная
          доставка по городу Москва и МО - до 2 часов. Срочная доставка цветов
          не осуществляется в праздники - Новый год, День Святого Валентина, 8
          Марта, День Матери и предпраздничные дни. При оформлении заказа
          укажите телефон получателя местного сотового оператора, чтобы флористы
          дозвонились до получателя при необходимости. При доставке в гостиницу
          или офисный центр, мы гарантируем доставку только до ресепшена, так
          как курьера могут не пропустить к гостиничному номеру или офисному
          кабинету. Если получатель будет отсутствовать на рабочем месте, курьер
          оставит заказ у коллег, если они подтвердят, что получатель в этот
          день на работе. При передаче заказа курьер сообщает получателю о том,
          что доставленный букет оплачен. Мы не говорим имя заказчика и не
          передаём любые иные сведения. К цветам прилагается бесплатная
          открытка, в которой вы можете указать всё, что посчитаете нужным
        </Typography>
        <Box
          component="img"
          sx={pictureStyle}
