...
export async function getProducts(
  ...
  return axios.get<ProductsResponse>(
    `${process.env.REACT_APP_SERVER_URL}/product/products`,
    {
      params: {
        types: typesStr,
        minPrice,
...
export async function getProduct(id: number): Promise<AxiosResponse<IProduct>> {
  return axios.get<IProduct>(
    `${process.env.REACT_APP_SERVER_URL}/product/product`,
    {
      params: {
        id,
      },
...
export async function getProductsTypes(
  ...
  return axios.get<string[]>(
    `${process.env.REACT_APP_SERVER_URL}/product/types`,
    {
      params: {
        isFlower,
      },
