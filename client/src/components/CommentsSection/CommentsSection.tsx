        ...
        <Grid item xs={12} md={4}>
          <div data-aos="zoom-in-right" className="comment">
            ...
            >
              ...
              слез. Служба доставки работает качественно и быстро. Теперь буду
              чаще пользоваться вашими услугами! Еще раз спасибо, так держать!
            </Typography>
        ...
        <Grid item xs={12} md={4}>
          <div data-aos="zoom-in-up" className="comment">
            <Typography
              sx={{ ...commentTypographyStyle, ...commentHeaderStyle }}
            >
              Большое спасибо за ваши услуги. Впервые покупала у вас букет, и
              очень переживала, что он будет выглядеть не так красиво, как на
              фото. Букет доставили роскошный, он превзошел все мои ожидания!
              Фото отчет поднял настроение с утра! Молодцы ребята, обслуживание
              на высшем уровне!
            </Typography>
            <div data-aos="fade-up" className="comment-description">
              <Typography
